...
function addTab(){
    countTabs += 1;
    document.getElementById('tabs').innerHTML += `<li class="t-tab">Pestaña ${countTabs} </li>`;
    document.getElementById('tabs-cont').innerHTML += `<textarea class="t-content" name="contenido" id="contenido"></textarea>`
    easyTabs();
}